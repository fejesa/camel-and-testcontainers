...
public class PostgresSourceDatabaseTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    /**
     * Constructs a new {@link PostgresSourceDatabaseTestResource} and initializes the PostgreSQL container.
    ...
    public Map<String, String> start() {
        ...
        logger.info("The test source could be accessed through the following JDBC url: {}", container.getJdbcUrl());

        return Map.of("quarkus.datasource.source.jdbc.url", container.getJdbcUrl(),
                "timer.period", "100",
                "timer.delay", "0");
    }
    ...
    private String getDbPassword() {
        return ConfigProvider.getConfig().getValue("datasource.source.password", String.class);
    }
    ...
    private String getDbUser() {
        return ConfigProvider.getConfig().getValue("datasource.source.username", String.class);
    }
    ...
    private String getDbName() {
        return ConfigProvider.getConfig().getValue("datasource.source.dbname", String.class);
    }
    ...
    private Integer getDbPort() {
        return ConfigProvider.getConfig().getValue("datasource.source.port", Integer.class);
    }
}
